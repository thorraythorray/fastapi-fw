...
from app.openai.chat.schemas import OpenAIChatInputBody

router = APIRouter(tags=["OpenAI 兼容平台整合接口"])


@router.post("/completions")
async def get_qwen_stream_response(chat_input: OpenAIChatInputBody):
    client = AsyncOpenAI(
    ...
    return EventSourceResponse(completion)
